  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col lg:flex-row">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Top Sticky Header */}
        <header className="sticky top-0 z-30 h-16 bg-white/95 backdrop-blur-sm border-b border-slate-200 px-4 sm:px-6 flex items-center justify-between shadow-xs">
                    ...
                    <div className="max-h-80 overflow-y-auto divide-y divide-slate-100">
                      {recentNotifications?.data && recentNotifications.data.length > 0 ? (
                        recentNotifications.data.map(notif => (
                          ...
                          >
                            <div className={`w-2 h-2 rounded-full mt-1.5 flex-shrink-0 ${!notif.isRead ? 'bg-brand-600' : 'bg-transparent'}`} />
                            <div className="flex-1 min-w-0">
            ...
            <div className="relative">
              ...
              {userDropdownOpen && (
                <>
                  ...
                  <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-xl border border-slate-200 z-50 py-1.5 animate-scale-up">
                    ...
                    <button
                      onClick={handleLogout}
                      className="w-full flex items-center gap-2 px-4 py-2 text-xs font-medium text-rose-600 hover:bg-rose-50 transition border-t border-slate-100"
                    >
